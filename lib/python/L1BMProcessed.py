...
# 定义需要读取的文件夹路径
folder_path = "C:\\Users\\HUAWEI\\Desktop\\L1" # 请替换为你的文件夹路径
            ...
            with open(file_path, 'r') as file:
                ...
                if len(lines) >= 34:  # 文件至少有34行
                    ...
                    for line in lines:
                        ...
                        sql = "INSERT INTO smos_radar_qzgcz_L1BMProcessed (Time,show_name,name,Platform_id, Height, SNR1, Rv1, SW1, SNR2, Rv2, SW2, SNR3, Rv3, SW3, SNR4, Rv4, SW4, SNR5, Rv5, SW5) VALUES (%s,%s,%s, %s,%s,%s, %s, %s, %s, %s, %s, %s, %s,%s, %s,%s, %s, %s, %s, %s)"
