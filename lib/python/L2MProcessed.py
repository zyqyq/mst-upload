...
for filename1 in os.listdir(folder_path):
    for filename2 in os.listdir(os.path.join(folder_path, filename1)):
        if filename2.endswith('M_processed.TXT'):   
            ...
            with open(file_path, 'r') as file:
                ...
                if len(lines) >= 23:  # 文件至少有34行
                    ...
                    for line in lines:
                        ...
                        # 执行 SQL 语句
                        sql = "INSERT INTO smos_radar_qzgcz_L2MProcessed (Time,show_name,name,Platform_id, Height, Horiz_WS, Horiz_WD, Verti_V, Cn2, Credi) VALUES (%s,%s, %s,%s,%s, %s, %s, %s, %s, %s)"
